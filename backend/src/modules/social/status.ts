...
//
// NOTA DE HONESTIDAD (consolidación E2E): esto usa cifrado en reposo con la
// clave del servidor (`encryptContent`/`decryptContent`), NO el sobre E2E
// del chat — nunca prometió serlo (es contenido tipo "estado", visible por
// varios contactos, no un mensaje 1:1), pero se deja explícito acá para que
// no se confunda con el resto del chat, que sí es E2E real desde esta
// consolidación. Ver FEATURE_CONSOLIDATION.md, sección 🔴.
